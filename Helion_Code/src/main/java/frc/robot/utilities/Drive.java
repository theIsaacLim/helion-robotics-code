...
public final class Drive {
    ...
    public Drive(TalonSRX leftFront, TalonSRX leftMiddle, TalonSRX leftBack, TalonSRX rightFront, TalonSRX rightMiddle,
            TalonSRX rightBack) {
    ...
    // This method is to limit the stick imputs to make sure that they dont go above
    // or below 1 or -1
